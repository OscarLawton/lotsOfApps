...
function main(){
    ...
    multi.onclick = function(){
        if (clickedAlready === false){
            console.log("first if of multi worked");
            num1 = Number(num);
            checkNumSize(num1.toString(),outContent);
            outContent.innerHTML = "" + num1.toString() + "";
            num = "0";
            ...
            console.log("first else of multi worked");
            num2 = Number(num);
            if(add === true){
                console.log("first if of else in multi ran");
                num1 =  addition(num1, num2);
                checkNumSize(num1.toString(),outContent);
                outContent.innerHTML = "" + num1.toString() + "";
                ...
                console.log("second if of else in multi ran");
                num1 = subtract(num1, num2) ;
                checkNumSize(num1.toString(),outContent);
                outContent.innerHTML = "" + num1.toString() + "";
                ...
                console.log("third if of else in multi ran");
                num1 = multiply(num1,num2);
                checkNumSize(num1.toString(),outContent);
                outContent.innerHTML = "" + num1.toString() + "";
                ...
                console.log("fourth if of else in multi ran");
                console.log("num1 is equal to: " + num1);
                console.log("num2 is equal to: " + num2);
                num1 = divideFunc(num1,num2);
                console.log("the answer is equal to: " + num1);
                checkNumSize(num1.toString(),outContent);
                outContent.innerHTML = "" + num1.toString() + "";
